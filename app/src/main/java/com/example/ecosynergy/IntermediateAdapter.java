...
public class IntermediateAdapter extends BaseAdapter {

    private  NavigationUtils.OnCategorySelectedListener listener;
    private final List<String> categoryList;
    // Constructor
    public IntermediateAdapter(List<String> items) {
        this.categoryList = items;
    }

    public IntermediateAdapter(List<String> items, NavigationUtils.OnCategorySelectedListener listener) {
        this.categoryList = items;
