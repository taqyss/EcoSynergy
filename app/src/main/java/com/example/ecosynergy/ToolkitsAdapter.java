...
public class ToolkitsAdapter extends BaseAdapter {

    private NavigationUtils.OnCategorySelectedListener listener;
    private final List<String> categoryList;
    // Constructor
    public ToolkitsAdapter(List<String> items) {
        this.categoryList = items;
    }

    public ToolkitsAdapter(List<String> items, NavigationUtils.OnCategorySelectedListener listener) {
        this.categoryList = items;
